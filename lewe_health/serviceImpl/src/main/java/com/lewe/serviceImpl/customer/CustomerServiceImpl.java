...
public class CustomerServiceImpl implements ICustomerService{
	...
	public String sendSmsCode(String phone, Object apiResult) {
		...
		if(phone.startsWith("140")||phone.startsWith("150")) {
			smsCode = 1234;
		}
	...
	public JSONObject myReportInfo(Long reportId, Object apiResult) {
		...
		if(reportInfo!=null) {
			...
			json.put("analysisTime", reportInfo.getCheckTime()==null?null:DateUtil.formatDate(reportInfo.getCheckTime(), "yyyy-MM-dd"));//分析样本时间
