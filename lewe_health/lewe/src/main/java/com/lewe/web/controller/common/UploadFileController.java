...
public class UploadFileController extends BaseController {
	...
	public ApiResult uploadImg(HttpServletRequest request,
			@RequestParam(required = false, name = "imageFile") MultipartFile imageFile, HttpServletResponse response) {
	...
	public ApiResult uploadReport(HttpServletRequest request, String base64str, Integer type, Long reportInfoId,
		...
		response.setHeader("Access-Control-Allow-Headers",
				"x-requested-with,xm-api-type,App-Key,Access-Token,wechat-id,Cookie,token,Content-Type,Sign");
